...
# Optional cloudscraper#!/usr/bin/env python3
"""
Scraper for Meteli, Kohokohdat and Keikat.org.
"""
import json
...
def main():
    ...
    all_events = merge_events(meteli_events, kohokohdat_events, keikat_org_events)
    ...
    output = {
        ...
        "source_note": "Auto-scraped from 3 sources. Music gigs only — theatre/comedy filtered out.",
        "errors": errors,
